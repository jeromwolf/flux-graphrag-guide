    ...
    >
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="font-semibold mb-2" style={{ color: 'var(--accent-red)' }}>
              일반 지식 질문 (필터링 대상)
            </div>
            <ul className="text-sm space-y-2" style={{ color: 'var(--text-secondary)' }}>
              <li>- &quot;열압착이란 무엇인가?&quot;</li>
        ...
        <div className="mt-4 text-sm space-y-2" style={{ color: 'var(--text-secondary)' }}>
          <p><strong style={{ color: 'var(--text-primary)' }}>필터링 기준:</strong></p>
